...
function menuCAClick(url,_this){
	...
	if($(_this).find("i").attr("class") == "fa fa-user"){
		$("#frameMainTitle span").html($(_this).html());
		return;
	}
	if($(_this).text() == "修改密码"){
		$("#frameMainTitle span").html($(_this).html());
